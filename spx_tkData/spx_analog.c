...
//	INA3221_write( INA3221_id2busaddr(1), INA3231_CONF, res, 2 );
	INA_write( 0, INA3231_CONF, res, 2 );
	INA_write( 1, INA3231_CONF, res, 2 );
...
//	INA3221_read( INA3221_id2busaddr(ina_id), ina_reg, res ,2 );
	...
	*mag_val = an_mag_val;
	...
	xprintf_P( PSTR("ch %d: ina_id=%d,ina_reg=%0x,raw_val=%d\r\n\0"), channel,ina_id,ina_reg,an_raw_val);
}
//------------------------------------------------------------------------------------
...
char res[3];
	...
	*mag_val = an_mag_val;
	...
	xprintf_P( PSTR("BAT: ina_id=%d,ina_reg=%0x,raw_val=%d\r\n\0"),ina_id,ina_reg,an_raw_val);
}
//------------------------------------------------------------------------------------
